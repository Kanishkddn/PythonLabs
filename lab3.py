...
# x=num+num2 #input function takes value as strings so when added, it doesnt add like numbers but as strings
# a=int(input("Enter num1: "))
# b=int(input("Enter num2: "))
# c=a+b
# print("the sum is:",c) #Now the sum works like integar because we have specified it as int
